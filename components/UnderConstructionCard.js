...
export default function UnderConstructionCard({
  ...
  const handleMouseEnter = (e) => {
    ...
    try {
      ...
      if (globalThis.window !== 'undefined' && left + TOOLTIP_WIDTH > (window.innerWidth - padding)) {
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-xs font-semibold text-gray-700 mb-.5 line-through leading-tight">{title}</h3>
        ...
        {children ? (
          ...
          <>
            <div className="mb-1.5">
              ...
              {subtitle && <p className="text-xs text-gray-600 mt-.5 leading-tight">{subtitle}</p>}
            </div>
      ...
      {showTooltip && createPortal(
        <div
          ...
          className="w-60 bg-white border border-gray-200 rounded-lg shadow-xl p-3 animate-in fade-in zoom-in duration-200"
        >
